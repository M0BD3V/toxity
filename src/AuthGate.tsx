...
function AuthScreen({ onPreview, setupOnly = false }: { onPreview: () => void; setupOnly?: boolean }) {
  ...
  return <main className="auth-shell">
    <section className="auth-story">
      <img src="/assets/brand/svg/toxity-symbol.svg" alt="Toxity" />
    ...
    <section className="auth-panel">
      <div className="auth-card">
        <div className="auth-mobile-brand"><img src="/assets/brand/svg/toxity-symbol.svg" alt="" /><strong>Toxity</strong></div>
